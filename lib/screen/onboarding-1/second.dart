...
import 'package:onboarding_soglom_ayol/screen/onboarding-1/third.dart';
    ...
    return Container(
      decoration: BoxDecoration(
        image: DecorationImage(
            image: AssetImage('assets/images/onboarding-1/second.jpg'),
            fit: BoxFit.cover
        ),
      ),
      child: Scaffold(
            ...
            child: Column(
              children: [
                ...
                Center(
                  child: Column(
                    children: [
                      Text("KUNDALIK MASHG'ULOT", style: GoogleFonts.poppins(
